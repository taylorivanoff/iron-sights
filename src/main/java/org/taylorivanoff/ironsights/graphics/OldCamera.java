...
// public class OldCamera extends Component {
...
// public OldCamera(int width, int height) {
...
// float verticalOffset = (float) Math.sin(headBobTimer) *
// headBobVerticalAmount;
// float horizontalOffset = (float) Math.cos(headBobTimer * 2) *
...
// Vector3f forward = calculateForwardVector();
// Vector3f right = calculateRightVector(forward);
// Vector3f horizontalForward = new Vector3f(forward.x, 0,
// forward.z).normalize();
...
// Vector3f displacement = new Vector3f(velocity).mul(delta);
